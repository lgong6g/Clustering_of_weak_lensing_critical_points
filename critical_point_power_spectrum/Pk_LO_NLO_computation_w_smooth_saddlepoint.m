...
g10000 = Import["/home/barthele/Laurence/peak_correlation/renormalized_bias_functions_pvs/gs10000_table_planck18_cosmology_nu-3to6_dnu0.1_15arcmin_smooth.m"];
g10000 = g10000//Interpolation;
g1000 = g10000[0.3];

g01000 = Import["/home/barthele/Laurence/peak_correlation/renormalized_bias_functions_pvs/gs01000_table_planck18_cosmology_nu-3to6_dnu0.1_15arcmin_smooth.m"];
g01000 = g01000//Interpolation;
g0100 = g01000[0.3];

g20000 = Import["/home/barthele/Laurence/peak_correlation/renormalized_bias_functions_pvs/gs20000_table_planck18_cosmology_nu-3to6_dnu0.1_15arcmin_smooth.m"];
g20000 = g20000//Interpolation;
g2000 = g20000[0.3];

g11000 = Import["/home/barthele/Laurence/peak_correlation/renormalized_bias_functions_pvs/gs11000_table_planck18_cosmology_nu-3to6_dnu0.1_15arcmin_smooth.m"];
g11000 = g11000//Interpolation;
g1100 = g11000[0.3];

g02000 = Import["/home/barthele/Laurence/peak_correlation/renormalized_bias_functions_pvs/gs02000_table_planck18_cosmology_nu-3to6_dnu0.1_15arcmin_smooth.m"];
g02000 = g02000//Interpolation;
g0200 = g02000[0.3];

g00100 = Import["/home/barthele/Laurence/peak_correlation/renormalized_bias_functions_pvs/gs00100_table_planck18_cosmology_nu-3to6_dnu0.1_15arcmin_smooth.m"];
g00100 = g00100//Interpolation;
g0010 = g00100[0.3];

g00010 = Import["/home/barthele/Laurence/peak_correlation/renormalized_bias_functions_pvs/gs00010_table_planck18_cosmology_nu-3to6_dnu0.1_15arcmin_smooth.m"];
...
pks = ReadList["/home/barthele/Laurence/peak_correlation/projected_2d_kappa_power_spectrum_ell0_to_2e4_121bins.dat", Number, RecordLists -> True] // Flatten;
...
Xtable = Import["/home/barthele/Laurence/peak_correlation/X_table_r_nbessel_mk_planck18_cosmology_dirac_delta_z_r1.0_dr_0.0001_ell0_to_2e4_15arcmin_smooth.m"];
Xtable = Xtable // Flatten[#, 2] &;
X = Xtable // Interpolation;

X01table = Import["/home/barthele/Laurence/peak_correlation/X_chi_01_table_r_nbessel_mk_planck18_cosmology_dirac_delta_z_r0.3_dr_0.0001_dz_0.01_ell0_to_2e4_15arcmin_smooth.m"];
X01table = X01table // Flatten[#, 1] &;
X01 = X01table // Interpolation;
X03table = Import["/home/barthele/Laurence/peak_correlation/X_chi_03_table_r_nbessel_mk_planck18_cosmology_dirac_delta_z_r0.3_dr_0.0001_dz_0.01_ell0_to_2e4_15arcmin_smooth.m"];
X03table = X03table // Flatten[#, 1] &;
X03 = X03table // Interpolation;
X10table = Import["/home/barthele/Laurence/peak_correlation/X_chi_10_table_r_nbessel_mk_planck18_cosmology_dirac_delta_z_r0.3_dr_0.0001_dz_0.01_ell0_to_2e4_15arcmin_smooth.m"];
X10table = X10table // Flatten[#, 1] &;
X10 = X10table // Interpolation;
X12table = Import["/home/barthele/Laurence/peak_correlation/X_chi_12_table_r_nbessel_mk_planck18_cosmology_dirac_delta_z_r0.3_dr_0.0001_dz_0.01_ell0_to_2e4_15arcmin_smooth.m"];
X12table = X12table // Flatten[#, 1] &;
X12 = X12table // Interpolation;
X14table = Import["/home/barthele/Laurence/peak_correlation/X_chi_14_table_r_nbessel_mk_planck18_cosmology_dirac_delta_z_r0.3_dr_0.0001_dz_0.01_ell0_to_2e4_15arcmin_smooth.m"];
X14table = X14table // Flatten[#, 1] &;
X14 = X14table // Interpolation;
X21table = Import["/home/barthele/Laurence/peak_correlation/X_chi_21_table_r_nbessel_mk_planck18_cosmology_dirac_delta_z_r0.3_dr_0.0001_dz_0.01_ell0_to_2e4_15arcmin_smooth.m"];
X21table = X21table // Flatten[#, 1] &;
X21 = X21table // Interpolation;
X23table = Import["/home/barthele/Laurence/peak_correlation/X_chi_23_table_r_nbessel_mk_planck18_cosmology_dirac_delta_z_r0.3_dr_0.0001_dz_0.01_ell0_to_2e4_15arcmin_smooth.m"];
X23table = X23table // Flatten[#, 1] &;
X23 = X23table // Interpolation;
X32table = Import["/home/barthele/Laurence/peak_correlation/X_chi_32_table_r_nbessel_mk_planck18_cosmology_dirac_delta_z_r0.3_dr_0.0001_dz_0.01_ell0_to_2e4_15arcmin_smooth.m"];
X32table = X32table // Flatten[#, 1] &;
X32 = X32table // Interpolation;
X34table = Import["/home/barthele/Laurence/peak_correlation/X_chi_34_table_r_nbessel_mk_planck18_cosmology_dirac_delta_z_r0.3_dr_0.0001_dz_0.01_ell0_to_2e4_15arcmin_smooth.m"];
X34table = X34table // Flatten[#, 1] &;
X34 = X34table // Interpolation;
X43table = Import["/home/barthele/Laurence/peak_correlation/X_chi_43_table_r_nbessel_mk_planck18_cosmology_dirac_delta_z_r0.3_dr_0.0001_dz_0.01_ell0_to_2e4_15arcmin_smooth.m"];
...
Export["/home/barthele/Laurence/peak_correlation/saddle_points/PkLO_saddle_nu0.3_correction_planck18_cosmology_dirac_delta_z_lmin0_lmax2e4_15arcmin_smooth.m", Pklinear];
...
lnew = ReadList["/home/barthele/Laurence/peak_correlation/k_values_1_5000_100_logspace.dat", Number, RecordLists -> True] // Flatten;

Pksquaretable = ParallelTable[{k, Pksquare[k]}, {k, l}];
Export["/home/barthele/Laurence/peak_correlation/saddle_points/PkNLOsquare_saddle_nu0.3_correction_planck18_cosmology_dirac_delta_z_lmin0_lmax2e4_r1.0_dr_0.0001_15arcmin_smooth.m", Pksquaretable];

PkBtable = ParallelTable[{k, PkB[k]}, {k, l}];
Export["/home/barthele/Laurence/peak_correlation/saddle_points/PkNLOB_saddle_nu0.3_correction_planck18_cosmology_dirac_delta_z_lmin0_lmax2e4_r0.3_dr_0001_z_1.5_dz_0.01_15arcmin_smooth.m", PkBtable];
